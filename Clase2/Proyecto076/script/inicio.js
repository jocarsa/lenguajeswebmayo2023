...
document.getElementById("registrate").onclick = function(){
    ...
    document.getElementById("principal").innerHTML = `
                <div id="login">
                    ...
                    <button id="loginboton">Entrar</button>
                    <p>
                    Al registrarte, aceptas nuestras Condiciones. Obtén más información sobre cómo recopilamos, usamos y compartimos tu información en la Política de privacidad, así como el uso que hacemos de las cookies y tecnologías similares en nuestra Política de cookies.</p>
                </div>
            `
}
