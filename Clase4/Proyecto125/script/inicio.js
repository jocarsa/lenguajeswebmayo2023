    ...
    for(var i = 0; i < elementos.length; i++) {
            ...
            elemento.onclick = function() {
                ...
                document.getElementById("botonenviomensaje").onclick = function(){
                    ...
                    fetch("servidor/mensaje.php?remitente="+encodeURI(remitente)+"&destinatario="+encodeURI(destinatario)+"&mensaje="+encodeURI(mensaje))
...
document.getElementById("registrate").onclick = function(){
    ...
    document.getElementById("registroboton").onclick = function(){
        ...
        fetch("https://ideaoniric.com/admin/json/registranuevousuario.php?usuario="+tuusuario+"&contrasena="+tucontrasena+"&nombre="+tunombre+"&correo="+tucorreo)
        .then(res => res.json())
